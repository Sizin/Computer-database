...
$(".pageRange").click(function() {
	...
	document.location =  "/webapp/Dashboard?range="+range;
...
$(".page-item").click(function(){
	...
	document.location =  "/webapp/Dashboard?page="+page;
});

$("#firstPage").click(function(){
	document.location = "/webapp/Dashboard?page=1";
});
...
$("#nextPage").click(function(){
	...
	document.location = "/webapp/Dashboard?page=" + pageToGo;
});
...
$("#lastPage").click(function(){
	...
	document.location = "/webapp/Dashboard?page=" + lastPage;
});
